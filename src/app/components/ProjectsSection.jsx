...
const projectsData = [
  ...
  {
    id: 2,
    title: "Harbiye Kuaför - Modern Hair Salon Website",
    description:
      "A modern, responsive website for Ömer Saçaklı Hair Salon in Istanbul Şişli Harbiye. Features service listings, gallery showcase, customer testimonials, appointment booking system, and responsive design. Built with modern web technologies for optimal user experience.",
    image: "/images/projects/harbiyekuafor.png",
    tag: ["All", "Web"],
    gitUrl: "/",
    previewUrl: "https://harbiyekuafor.com/",
